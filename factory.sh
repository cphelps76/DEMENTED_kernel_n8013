...
export INITRAMFS_SOURCE=`readlink -f ..`/n8013/Ramdisks/N8013
export CONFIG_AOSP_BUILD=y
export PACKAGEDIR=$KERNELDIR/Packages
# Path to Kernel Factory Out folder
kout=~/kernel/out/GT-N8013
# enable ccache
export USE_CCACHE=1
#Enable FIPS mode
...
export CROSS_COMPILE=/home/*/kernel/arm-eabi-4.7/bin/arm-eabi-
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	./mkbootimg --cmdline 'console = null user_debug=31 zcache' --kernel $PACKAGEDIR/zImage --ramdisk $PACKAGEDIR/ramdisk.gz --base 0x80200000 --pagesize 2048 --ramdisk_offset 0x02000000 --output $PACKAGEDIR/boot.img 
	...
	zip -r $PACKAGEDIR/DEMENTEDKernel-GT-N8013-$curdate.zip .
        cp $PACKAGEDIR/DEMENTEDKernel-GT-N8013-$curdate.zip $kout/DEMENTEDKernel-GT-N8013-$curdate.zip
	cd $KERNELDIR
else
